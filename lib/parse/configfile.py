...
from lib.core.exception import GeccoFilePathException, GeccoMissingMandatoryOptionException, \
    GeccoValueException
...
def config_file_parser(configFile):
    ...
    if not os.path.isfile(configFile):
        raise GeccoFilePathException("file '{}' don't exist".format(configFile))
    ...
    if not config.has_section("Target"):
        ...
        raise GeccoMissingMandatoryOptionException(errMsg)
        ...
        if options:
            for option in options:
                ...
                try:
                    ...
                    raise GeccoValueException(errMsg)
