...
class VUL_TYPE:
    ...
    CSRF = 'CSRF'
    XSS = 'XSS'
    XSS_EXC = 'XSS EXCAVATE'
    UXSS = 'UXSS'
    SSRF = 'Server-Side Request Forgery'
    SSRF_EXC = 'Server-Side Request Forgery EXCAVATE'
    SHELLCODE = 'ShellCode'
    SQL_INJECTION = 'SQL Injection'
    SQL_INJECTION_EXC = 'SQL Injection EXCAVATE'
    ...
    COMMAND_EXECUTION_EXC = 'Command Execution EXCAVATE'
    ...
    CODE_EXECUTION_EXC = 'Code Execution EXCAVATE'
